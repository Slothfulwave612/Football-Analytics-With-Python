...
kwargs_rings={'facecolor': '#d80499', 'alpha': 0.6})
        ...
        mask_round_to_2dp = np.repeat(self.range_max < 1, self.num_rings + 1)
        ...
        label_rotations = np.repeat(self.rotation_degrees, self.num_rings + 1)
        ...
        label_radius = (np.linspace(self.ring_width,
                                                                self.ring_width * (self.num_rings + 1),
                                                                self.num_rings + 1))
...
kwargs_rings={'facecolor': '#d80499', 'alpha': 0.6})
        ...
        param_radius = self.center_circle_radius + (self.ring_width * (self.num_rings + 1))
